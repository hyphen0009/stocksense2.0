      ...
      <div className="flex min-h-screen w-full bg-[#F8FAFC]">
        <Sidebar className="border-r border-slate-200/60 bg-white shadow-xl shadow-slate-200/50">
          <SidebarHeader className="p-6 pb-2 mb-4 flex flex-row items-center gap-3">
            <div className="bg-primary p-2.5 rounded-2xl shadow-lg shadow-primary/20 transition-transform hover:scale-105 duration-300">
              <Store className="w-6 h-6 text-white" />
            </div>
            <div className="flex flex-col">
              <span className="text-xl font-bold text-slate-900 font-headline leading-none">KiranaLink</span>
              <span className="text-[10px] font-bold text-primary tracking-[0.2em] uppercase mt-1">Smart OS</span>
            </div>
          </SidebarHeader>
